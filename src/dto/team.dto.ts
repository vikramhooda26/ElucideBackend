...
export class TeamResponseDTO {
  ...
  static toResponse(teamDetails: TTeamDetails): TeamResponseDTO {
    ...
    (teamDTO.id = teamDetails.id.toString()), (teamDTO.name = teamDetails.team_name);
    ...
    (teamDTO.yearOfInception = teamDetails.year_of_inception), (teamDTO.franchiseFee = teamDetails.franchise_fee);
    teamDTO.city = {
    ...
    teamDTO.endorsements = teamDetails.dashapp_teamendorsements.map((endorse) => ({
      id: endorse.id.toString(),
      name: endorse.name,
      active: endorse.active,
    }));
    teamDTO.activeCampaigns = teamDetails.dashapp_team_active_campaigns.map((activeCampaign) => ({
      id: activeCampaign.dashapp_activecampaigns.id.toString(),
      name: activeCampaign.dashapp_activecampaigns.name,
    }));
    teamDTO.primaryMarketingPlatform = teamDetails.dashapp_team_marketing_platforms_primary.map((platform) => ({
      id: platform.dashapp_marketingplatform.id.toString(),
      name: platform.dashapp_marketingplatform.platform,
    }));
    teamDTO.secondaryMarketingPlatform = teamDetails.dashapp_team_marketing_platforms_secondary.map((platform) => ({
      id: platform.dashapp_marketingplatform.id.toString(),
      name: platform.dashapp_marketingplatform.platform,
    }));
    ...
    teamDTO.primaryKeyMarket = teamDetails.dashapp_team_key_markets_primary.map((market) => ({
      id: market.dashapp_keymarket.id.toString(),
      name: market.dashapp_keymarket.zone,
    }));
    teamDTO.secondaryKeyMarket = teamDetails.dashapp_team_key_markets_secondary.map((market) => ({
      id: market.dashapp_keymarket.id.toString(),
      name: market.dashapp_keymarket.zone,
    }));
    teamDTO.tertiary = teamDetails.dashapp_team_key_markets_tertiary.map((state) => ({
    ...
    teamDTO.association = teamDetails.dashapp_team_association.map((association) => ({
    ...
    teamDTO.mainPersonalityTraits = teamDetails.mainPersonalities.map((trait) => ({
    ...
    teamDTO.sportsDealSummary = teamDetails.dashapp_sportsdealsummary.map((deal) => ({
      id: deal.id.toString(),
    ...
    teamDTO.activations = teamDetails.dashapp_activation.map(
      (activation) => ({
      ...
      (teamDTO.contactPersons = teamDetails.dashapp_teamcontact.map((contact) => ({
    ...
    teamDTO.ottPartnerMetrics = teamDetails.dashapp_ott_partner_metrics.map((metric) => ({
    ...
    teamDTO.broadcastPartnerMetrics = teamDetails.dashapp_broadcast_partner_metrics.map((metric) => ({
      id: metric.id.toString(),
      viewership: metric.viewership,
      reach: metric.reach,
      year: metric.year,
