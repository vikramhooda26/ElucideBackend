...
export class LeagueResponseDTO {
    ...
    static toResponse(leagueDetails: TLeagueDetails): LeagueResponseDTO {
        ...
        (leagueDTO.id = leagueDetails.id.toString()), (leagueDTO.name = leagueDetails.property_name);
        leagueDTO.sport = {
            id: leagueDetails.dashapp_sport?.id.toString(),
            name: leagueDetails.dashapp_sport?.name,
        };
        leagueDTO.owners = leagueDetails.dashapp_leagueinfo_owner.map((owner) => ({
        ...
        leagueDTO.taglines = leagueDetails.dashapp_leagueinfo_taglines.map((tagline) => ({
        ...
        leagueDTO.gender = leagueDetails.dashapp_leagueinfo_gender.map((gender) => ({
        ...
        leagueDTO.activeCampaigns = leagueDetails.dashapp_leagueinfo_active_campaigns.map((activeCampaign) => ({
            id: activeCampaign.dashapp_activecampaigns.id.toString(),
            name: activeCampaign.dashapp_activecampaigns.name,
        }));
        leagueDTO.primaryKeyMarket = leagueDetails.dashapp_leagueinfo_key_markets_primary.map((market) => ({
            id: market.dashapp_keymarket.id.toString(),
            name: market.dashapp_keymarket.zone,
        }));
        leagueDTO.secondaryKeyMarket = leagueDetails.dashapp_leagueinfo_key_markets_secondary.map((market) => ({
            id: market.dashapp_keymarket.id.toString(),
            name: market.dashapp_keymarket.zone,
        }));
        leagueDTO.tertiary = leagueDetails.dashapp_leagueinfo_key_markets_tertiary.map((state) => ({
            id: state.dashapp_states.id.toString(),
            name: state.dashapp_states.state,
        }));
        leagueDTO.primaryMarketingPlatform = leagueDetails.dashapp_leagueinfo_marketing_platforms_primary.map(
            (platform) => ({
                id: platform.dashapp_marketingplatform.id.toString(),
                name: platform.dashapp_marketingplatform.platform,
            }),
        );
        leagueDTO.secondaryMarketingPlatform = leagueDetails.dashapp_leagueinfo_marketing_platforms_secondary.map(
            (platform) => ({
                id: platform.dashapp_marketingplatform.id.toString(),
                name: platform.dashapp_marketingplatform.platform,
            }),
        );
        leagueDTO.association = leagueDetails.dashapp_leagueinfo_association.map((association) => ({
        ...
        leagueDTO.mainPersonalityTraits = leagueDetails.mainPersonalities.map((trait) => ({
        ...
        leagueDTO.endorsements = leagueDetails.dashapp_leagueendorsements.map((endorse) => ({
        ...
        leagueDTO.sportsDealSummary = leagueDetails.dashapp_sportsdealsummary.map((deal) => ({
            id: deal.id.toString(),
        ...
        leagueDTO.activations = leagueDetails.dashapp_activation.map(
            ...
            (leagueDTO.contactPersons = leagueDetails.dashapp_leaguecontact.map((contact) => ({
        ...
        leagueDTO.ottPartnerMetrics = leagueDetails.dashapp_ott_partner_metrics.map((metric) => ({
        ...
        leagueDTO.broadcastPartnerMetrics = leagueDetails.dashapp_broadcast_partner_metrics.map((metric) => ({
            id: metric.id.toString(),
            reach: metric?.reach,
            viewership: metric.viewership,
            year: metric?.year,
